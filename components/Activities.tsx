...
import { LITERARY_ACTIVITIES } from '../constants';
...
const Activities: React.FC = () => {
  ...
  return (
    ...
    >
      <SectionTitle>Literary Activities & Initiatives</SectionTitle>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {LITERARY_ACTIVITIES.map((activity) => (
          <div
            key={activity.title}
          ...
          >
            <div className="flex justify-center mb-4">
              <activity.Icon className="w-10 h-10 sm:w-12 sm:h-12 text-cyan-400" />
            </div>
